...
찾아서 쓴다 - 여기서 새로 만들지 않는다(못 찾으면 taxonomy 시딩을 먼저
안 돌린 것이므로 에러).
"""
...
def insert_problems(session: Session, problems: list[SenProblem], pdf_path: str | None = None) -> int:
...
if __name__ == '__main__':
    ...
    from pdf_sen_extract import extract_problems
